...
namespace PresentacionWeb.Sitio.Vista.Reportes.reportes {
    ...
    public class re_estctaaseg1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PresentacionWeb.Sitio.Vista.Reportes.reportes.re_estctaaseg1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedre_estctaaseg1 : Component, ICachedReport {
        
        public Cachedre_estctaaseg1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            re_estctaaseg1 rpt = new re_estctaaseg1();
            rpt.Site = this.Site;
            return rpt;
        }
