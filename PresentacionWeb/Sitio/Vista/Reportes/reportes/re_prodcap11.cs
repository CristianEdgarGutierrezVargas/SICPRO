...
namespace PresentacionWeb.Sitio.Vista.Reportes.reportes {
    ...
    public class re_prodcap1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PresentacionWeb.Sitio.Vista.Reportes.reportes.re_prodcap1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedre_prodcap1 : Component, ICachedReport {
        
        public Cachedre_prodcap1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            re_prodcap1 rpt = new re_prodcap1();
            rpt.Site = this.Site;
            return rpt;
        }
