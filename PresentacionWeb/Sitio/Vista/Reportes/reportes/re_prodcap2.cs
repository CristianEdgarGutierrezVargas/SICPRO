...
namespace PresentacionWeb.Sitio.Vista.Reportes.reportes {
    ...
    public class re_prodcap2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "PresentacionWeb.Sitio.Vista.Reportes.reportes.re_prodcap2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedre_prodcap2 : Component, ICachedReport {
        
        public Cachedre_prodcap2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            re_prodcap2 rpt = new re_prodcap2();
            rpt.Site = this.Site;
            return rpt;
        }
