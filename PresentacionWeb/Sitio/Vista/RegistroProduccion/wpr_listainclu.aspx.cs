...
namespace PresentacionWeb.Sitio.Vista.RegistroProduccion
{
    public partial class wpr_listainclu : System.Web.UI.Page
    {
        ...
        private void Datos()
        {
            ...
            var lstResponse = _objConsumoRegistroProd.ObtenerTablaPolizaI(objTablaPolizaIn);
            Session["LST_LISTA_INCLU"] = lstResponse;
        ...
        protected void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("~/Sitio/Vista/RegistroProduccion/wpr_listainclu.aspx");
        }
        ...
        protected void btnSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("wpr_polizainclu.aspx?var=" + idPoliza + "&val=" + idMovimiento);
        ...
        {
            if (Session["LST_LISTA_INCLU"] != null)
            {
                gridpoliza.DataSource = Session["LST_LISTA_INCLU"];
            }
        }
