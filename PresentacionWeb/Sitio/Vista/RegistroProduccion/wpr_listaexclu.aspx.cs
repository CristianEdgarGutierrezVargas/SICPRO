...
{
    public partial class wpr_listaexclu : System.Web.UI.Page
    {
        ...
        private void Datos()
        {
            ...
            var lstResponse = _objConsumoRegistroProd.ObtenerTablaPolizaEx(objTablaPolizaIn);
            Session["LST_LISTA_EXCLU"] = lstResponse;
        ...
        protected void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("~/Sitio/Vista/RegistroProduccion/wpr_listaexclu.aspx");
        }
        ...
        protected void btnSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("wpr_polizaexclu.aspx?var=" + idPoliza + "&val=" + idMovimiento);
        ...
        {
            if (Session["LST_LISTA_EXCLU"] != null)
            {
                gridpoliza.DataSource = Session["LST_LISTA_EXCLU"];
            }
        }
