...
<%@ Register Assembly="DevExpress.Web.Bootstrap.v23.1, Version=23.1.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.Bootstrap" TagPrefix="dxB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderPrincipal" runat="server">
    ...
    <div class="container rounded-3 p-4" style="background-color: rgb(243, 243, 243);">
        ...
        <div class="row">
            ...
            <div class="col-10">
                <dx:ASPxCallbackPanel ID="pnlCallBackCierreRegistro" ClientInstanceName="pnlCallBackCierreRegistro" runat="server" Width="200px" OnCallback="pnlCallBackCierreRegistro_Callback" SettingsLoadingPanel-Delay="2000" EnableCallbackAnimation="true" CssClass="w-100">
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <asp:DropDownList ID="anio" runat="server" Style="color: #0F5B96; background-color: White; font-family: Arial,Helvetica,sans-serif; font-size: 11px; font-weight: bold;" AutoPostBack="true" OnSelectedIndexChanged="anio_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <dxB:BootstrapDateEdit ID="ini_reg" runat="server">
                                        <cssclasses button="btn-sm" input="form-control-sm fs-10" />
                                    </dxB:BootstrapDateEdit>
                                </div>
                                <div class="col-2">
                                    <label>Fin. Registro :</label>
                                </div>
                                <div class="col-3">
                                    <dxB:BootstrapDateEdit ID="fin_reg" runat="server">
                                        <cssclasses button="btn-sm" input="form-control-sm fs-10" />
                                    </dxB:BootstrapDateEdit>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col-11">
                        <dx:ASPxGridView ID="gridcierre" runat="server" Settings-ShowTitlePanel="true" SettingsText-Title="Lista de Direcciones" OnDataBinding="gridcierre_DataBinding"
                            ...
                            <Columns>
                                <dx:GridViewDataColumn>
                                    <DataItemTemplate>
                                        ...
                                        <asp:ImageButton runat="server" ImageUrl="~/UI/img/front.png" CommandName="UPDATE" OnClick="Unnamed_Click"  CommandArgument='<%# Eval("mes")+"|"+Eval("anio")+"|"+Eval("ini_reg")+"|"+Eval("fin_reg")+"|"+Eval("tcambio") %>' />
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
