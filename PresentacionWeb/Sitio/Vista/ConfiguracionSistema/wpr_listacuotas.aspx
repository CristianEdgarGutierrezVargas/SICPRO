            ...
            <dx:PopupControlContentControl runat="server">
                <div class="row">
                    <div class="col-3">
                        ...
                        <dx:ASPxButton ID="btnserper_modal" runat="server" Text="Buscar" CssClass="msg_button_class" AutoPostBack="false">
                            <%--<ClientSideEvents Click="function(s,e){
                    ...
                    <div class="col-9">
                        <dx:ASPxCallbackPanel ID="pnlCallBackBuscaPersonas" ClientInstanceName="pnlCallBackBuscaPersona" runat="server" Width="200px" SettingsLoadingPanel-Delay="2000" EnableCallbackAnimation="true">
                            <PanelCollection>
        ...
        <ContentCollection>
            <dx:PopupControlContentControl runat="server">
                <div class="row">
                    <div class="col-3">
                        <img src="../../../UI/img/search_user.png" width="48" height="48">
                        <dx:ASPxTextBox ID="nomco1" ClientInstanceName="nomraz1" runat="server" AutoCompleteType="None" Size="12"></dx:ASPxTextBox>
        ...
        <ContentCollection>
            <dx:PopupControlContentControl runat="server">
                <div class="row">
                    <div class="col-3">
                        <img src="../../../UI/img/search_user.png" width="48" height="48">
                        <dx:ASPxTextBox ID="ASPxTextBox1" ClientInstanceName="nomraz1" runat="server" AutoCompleteType="None" Size="12"></dx:ASPxTextBox>
