    ...
    public partial class wpr_listacom3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Limpiar();
                wpr_listacom3.valor = base.Request.QueryString["var"];
        ...
        private void Datos()
        {
            ...
            var dataTable = _objConsumoModCom.VcoObtenerTablaPolizaNRI3(item, num_poliza.Text, id_per.Value, id_spvs.Value, id_producto.Value, vigencia.Checked, fc_inivig.Date, fc_finvig.Date, fc_polizavencida.Date, porvencer.Checked, estado);
