...
namespace ManejadorMetodosSql
{
    public class CStoredProcedureBase
    {
        ...
        public object SelectField(string sqlStatement, List<CParameter> lstParameters)
        {
            object o = null;
        ...
        public object SelectObject(string sqlStatement, object objeto, List<CParameter> lstParameters)
        {
        ...
        public List<object> SelectListObject(string sqlStatement, object objeto, List<CParameter> lstParameters)
        {
            object objectInstance = null;
        ...
        public DataTable SelectDatatable(string sqlStatement, List<CParameter> lstParameters)
        {
            SqlDataReader rdr = null;
        ...
        public bool RunQuery(string sqlStatement, List<CParameter> lstParameters)
        {
            SqlConnection con = null;
            SqlCommand cmd = null;
        ...
        public bool RunStoredProcedure(string sqlStoredProcedure, List<CParameter> lstParameters)
        {
            SqlConnection con = null;
            SqlCommand cmd = null;
        ...
        public object RunStoredProcedureField(string sqlStoredProcedure, List<CParameter> lstParameters)
        {
            object oField = null;
        ...
        //PERMITE EJECUCION DE SP CON UN REPUESTA OBJECT DEL SP  ---ok--
        public object RunStoredProcedureObj(string sqlStoredProcedure, object objeto, List<CParameter> lstParameters)
        {
            object objectInstance = null;
        ...
        public List<object> RunStoredProcedureList(string sqlStoredProcedure, object objeto, List<CParameter> lstParameters)
        {
            object objectInstance = null;
            var lstInstance = new List<object>();
        ...
        public DataTable GetDataTable(string sqlStoredProcedure, List<CParameter> lstParameters)
        {
            SqlDataAdapter rda = null;
            SqlConnection con = null;
            SqlCommand cmd = null;
        ...
        public DataSet GetDataSet(string sqlStoredProcedure, List<CParameter> lstParameters)
        {
            SqlDataAdapter rda = null;
            SqlConnection con = null;
            SqlCommand cmd = null;
